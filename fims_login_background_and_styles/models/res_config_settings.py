...
class ResConfigSettings(models.TransientModel):
    ...
    style = fields.Selection([('default', 'Default'), ('left', 'Left'), ('right', 'Right'), ('middle', 'Middle')], default='middle',
                             config_parameter='fims_login_background_and_styles.style', help='Select Background Theme')
    background = fields.Selection([('image', 'Image'), ('color', 'Color')], default='color', help='Select Background Theme',
                                  config_parameter='fims_login_background_and_styles.background')
    background_image = fields.Many2one('login.image', string="Image", help='Select Background Image For Login Page',
                                       config_parameter='fims_login_background_and_styles.background_image')
    color = fields.Char(string="Color", help="Choose your Background color", default="#ECDADA", config_parameter='fims_login_background_and_styles.color')
    ...
    #     print(self.env['ir.config_parameter'].sudo().get_param('login_background'))
    #     res.update(
