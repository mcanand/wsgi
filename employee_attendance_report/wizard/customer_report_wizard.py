...
class AttendanceReportWizard(models.TransientModel):
    ...
    #     }
    #     return self.env.ref(
    #         'employee_attendance_report.action_report_print_statement').report_action(
    #         self, data=data)
    ...
    def print_report_xls(self):
        ...
        if self.from_date and self.to_date:
            ...
            return self.env.ref(
                'employee_attendance_report.record_attendance_xls').report_action(
                self, data=data)


    # def get_xlsx_report(self, workbook, data, lines):
    ...
    #     sheet1.set_column(7, 7, 20)
        ...
        #
        #         }]
        #     elif rec.account_id.account_type == 'asset_payable':
        #         entry_data_dict = [
        #             {
        #                 'entry_date': rec.move_id.date.strftime('%d/%m/%Y'),
        #                 'entry_no': rec.move_id.name,
        ...
        # sheet1.write(j, 5, 'Due Date', sub_heading)
        # sheet1.write(j, 6, 'Outstanding Amount', sub_heading)
        # j += 1
        # t = 0
        # entry_total = 0
        #
        ...
        #     # sheet1.write(j, t,'',  format2)
        #     # t += 1
        #     sheet1.write(j, t, '{0:,.3f}'.format(data['entry_amount'])  )
        #     j += 1
        #
        # j += 2
        #
        ...
        #         t += 1
        #         sheet1.write(j, t, vals['order_no'], format2)
        #         t += 1
        ...
        #         t += 1
        #         sheet1.write(j, t, '{0:,.3f}'.format(vals['due_amount'])  , format2)
        #         j += 1
        #     sheet1.write(j, t-1, 'Total', total_head)
        #     sheet1.write(j, t,  '{0:,.3f}'.format(month_total)  , total_head)
        #     j += 2
        ...
        #
        # sheet1.write(j, 5, 'Sub Total', sub_total_head)
        # sheet1.write(j, 6, '{0:,.3f}'.format(sub_total + entry_total) , sub_total_head)
        # j += 2
        #
        #
        #
        ...
        #
        # value_dict = {}
        # val_data = self.env['account.move'].search(
        ...
        #
        # for rec in val_data:
        #     ppch_ids = self.env['account.payment'].search([('ref', '=', rec.name) ])
        #     for ppc in ppch_ids:
        #         key = ppc.id
        #         inv_numbres = ''
        #
        ...
        #                 'name': ppc.name,
        #                 'date': ppc.date.strftime('%d/%m/%Y'),
        #                 'amount': ppc.amount,
        #                 'invoice_number': ppc.ref,
        #             })
        #
        #         else:
        #
        ...
        #             })]
        # new_val_dict = []
        # for new_rec in value_dict:
        #     new_val_dict.append(value_dict[new_rec][0])
        #
        #
        ...
        #             sheet1.write(j, t, vals['due_date'], format2)
        #             t += 1
        #             sheet1.write(j, t, '{0:,.3f}'.format(vals['due_amount'])  ,
        #                          format2)
        #             j += 1
        #         sheet1.write(j, 5, 'Total', total_head)
        #         sheet1.write(j, 6, '{0:,.3f}'.format(vendor_month_total) , total_head)
        #         j += 2
        #         vendor_sub_total += vendor_month_total
        #     sheet1.write(j, 5, 'Sub Total', sub_total_head)
        #     sheet1.write(j, 6, '{0:,.3f}'.format(vendor_sub_total)  , sub_total_head)
        #     j += 2
        #
        # pdc_sub_total = 0
        # ppc_sub_total = 0
        ...
        #
        # if new_val_dict:
        #     sheet1.write(j, 0, 'CASH PAYMENTS', sub_heading)
        #
        #     j += 3
        #     sl = 0
        #
        #     sheet1.write(j, 0, 'Sl No', sub_heading)
        #     sheet1.write(j, 1, 'Reference No', sub_heading)
        #     sheet1.write(j, 2, 'Invoice No', sub_heading)
        #     sheet1.write(j, 3, ' Date', sub_heading)
        #     sheet1.write(j, 4, ' Amount', sub_heading)
        #     j += 1
        #
        #     for pdc in new_val_dict:
        #         ppc_sub_total += pdc['amount']
        #         t = 0
        #         sl += 1
        #         sheet1.write(j, t, sl, format2)
        #         t += 1
        ...
        #
        # if entry_data:
        #     sheet1.write(j, 4, 'Grand Total', grand_total_head)
        #     sheet1.write(j, 5, '{0:,.3f}'.format(sub_total - vendor_sub_total + entry_total + pdc_sub_total+ppc_sub_total) , grand_total_head)
        #
        #     total_amount = '{0:,.3f}'.format(sub_total - vendor_sub_total + entry_total + pdc_sub_total + ppc_sub_total)
        # else:
        #     sheet1.write(j, 4, 'Grand Total', grand_total_head)
        #     sheet1.write(j, 5, '{0:,.3f}'.format(sub_total - vendor_sub_total + pdc_sub_total + ppc_sub_total )  , grand_total_head)
        #
        #
        #     total_amount = '{0:,.3f}'.format(sub_total - vendor_sub_total + pdc_sub_total + ppc_sub_total)
